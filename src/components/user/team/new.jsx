    ...
    <>
      ...
      <Tabs defaultValue="join" className="w-full">
        <TabsList className="mb-8 grid w-full grid-cols-2 space-x-4 bg-transparent">
          <TabsTrigger
            className="data-[state=active]:text-hackathon-blue-200 rounded bg-gray-200 py-2 text-xl font-bold text-gray-500 md:text-2xl"
            value="join"
          >
            Join a Team
          </TabsTrigger>
        ...
        <TabsContent className="items-center" value="join">
          <Card>
            ...
            <CardContent className="mt-8 flex flex-col items-center space-y-2">
              ...
              <Input
                className="border-hackathon-blue-200 w-1/2 rounded border-2 py-6 text-xl"
                id="team"
            ...
            <CardFooter className="flex flex-col items-center">
              <Button
                className="bg-hackathon-blue-200 mt-5 h-14 w-1/8 rounded text-2xl font-bold"
                onClick={handleJoin}
              >
                Join Team
              </Button>
